package info.passdaily.holy_angles_staff
...
class MainRepository(val apiHelper: ApiClient) {
    ...
    suspend fun getJoinLiveNew(academicId: Int,classId : Int,subjectId: Int,studentId : Int,schoolId :Int)
            = apiHelper.getJoinLiveNew(academicId,classId,subjectId,studentId,schoolId)
...
//            = apiHelper.getTakeAnswer(examId,examAttemptId,questionId)
    ...
    suspend fun getClassDetails(adminId: Int,accademicId :Int,schoolId:Int) = apiHelper.getClassDetails(adminId,accademicId,schoolId)

    //getMeetingListByAdmin(accademicId,adminId))
    suspend fun getMeetingListByAdmin(accademicId: Int,adminId :Int,schoolId :Int) = apiHelper.getMeetingListByAdmin(accademicId,adminId,schoolId)
