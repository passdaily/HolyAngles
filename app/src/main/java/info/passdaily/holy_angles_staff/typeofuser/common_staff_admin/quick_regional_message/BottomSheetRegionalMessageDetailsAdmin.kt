...
import info.passdaily.holy_angles_staff.databinding.BottomSheetMessageDetailsAdminBinding
import info.passdaily.holy_angles_staff.model.*
import info.passdaily.holy_angles_staff.services.ShowMoreTextView
...
import info.passdaily.holy_angles_staff.typeofuser.common_staff_admin.quick_message.send_to.*

@Suppress("DEPRECATION")
class BottomSheetRegionalMessageDetailsAdmin : BottomSheetDialogFragment {
...
//        this.gROUPID = gROUPID
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        buttonParent?.setOnClickListener {
            val dialog1 = SendToParentDialog(messageList,messageTabClicker,"SendUnicode/SendMessageToParents")
        ...
        buttonStaff?.setOnClickListener {
            val dialog1 = SendToStaffDialog(messageList,messageTabClicker,"StaffUnicode/SendMessageToStaffs")
            val transaction = requireActivity().supportFragmentManager.beginTransaction()
            transaction.setCustomAnimations(R.anim.slide_up, R.anim.slide_down)
            dialog1.show(transaction, SendToStaffDialog.TAG)
        }
        buttonGroup?.setOnClickListener {
            val dialog1 = SendToGroupDialog(messageList,messageTabClicker,"GroupUnicode/SendMessageToGroup")
            val transaction = requireActivity().supportFragmentManager.beginTransaction()
            transaction.setCustomAnimations(R.anim.slide_up, R.anim.slide_down)
        ...
        buttonPublicGroup?.setOnClickListener {
            val dialog1 = SendToPublicGroupDialog(messageList,messageTabClicker,"PublicGroupUnicode/SendMessageToPublicGroup")
            val transaction = requireActivity().supportFragmentManager.beginTransaction()
            transaction.setCustomAnimations(R.anim.slide_up, R.anim.slide_down)
        ...
        buttonPTA?.setOnClickListener {
            val dialog1 = SendToPTADialog(messageList,messageTabClicker,"PtaUnicode/SendMessageToPta")
            val transaction = requireActivity().supportFragmentManager.beginTransaction()
            transaction.setCustomAnimations(R.anim.slide_up, R.anim.slide_down)
        ...
        buttonConveyor?.setOnClickListener {
            val dialog1 = SendToConveyorDialog(messageList,messageTabClicker,"ConveyorUnicode/SendMessageToConveyor")
            val transaction = requireActivity().supportFragmentManager.beginTransaction()
            transaction.setCustomAnimations(R.anim.slide_up, R.anim.slide_down)
        ...
        buttonClassDivision?.setOnClickListener {
            val dialog1 = SendToClassDivisionDialog(messageList,messageTabClicker,"BulkMessageUnicode/SendMessageClassWise")
            val transaction = requireActivity().supportFragmentManager.beginTransaction()
            transaction.setCustomAnimations(R.anim.slide_up, R.anim.slide_down)
        ...
        buttonClassWise?.setOnClickListener {
            val dialog1 = SendToClassWiseDialog(messageList,messageTabClicker,"BulkMessageUnicode/SendClassSectionWise")
            val transaction = requireActivity().supportFragmentManager.beginTransaction()
            transaction.setCustomAnimations(R.anim.slide_up, R.anim.slide_down)
        ...
        buttonGroupWise?.setOnClickListener {
            val dialog1 = SendToGroupWiseDialog(messageList,messageTabClicker,"GroupWiseUnicode/MessageToGroupWise")
            val transaction = requireActivity().supportFragmentManager.beginTransaction()
            transaction.setCustomAnimations(R.anim.slide_up, R.anim.slide_down)
        ...
        buttonPublicGroupWise?.setOnClickListener {
            val dialog1 = SendToPublicGroupWiseDialog(messageList,messageTabClicker,"PublicGroupUnicode/SendMessageToPublicGroup")
            val transaction = requireActivity().supportFragmentManager.beginTransaction()
            transaction.setCustomAnimations(R.anim.slide_up, R.anim.slide_down)
