...
import info.passdaily.holy_angles_staff.databinding.BottomMarkRegisterCeBinding
import info.passdaily.holy_angles_staff.databinding.BottomMarkRegisterMspsLpupBinding
import info.passdaily.holy_angles_staff.model.*
import info.passdaily.holy_angles_staff.services.Utils


@Suppress("DEPRECATION")
class BottomMarkRegisterMspsLpUp : BottomSheetDialogFragment {
    ...
    private var _binding: BottomMarkRegisterMspsLpupBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = BottomMarkRegisterMspsLpupBinding.inflate(inflater, container, false)
        return binding.root
        // return view;
    }
...
//                                (editPassMarkInternal.toDouble() <= editOutOffMarkInternal.toDouble())) {
                                ...
                                if (isTestedPT && isTestedPF && isTestedSEA && isTestedE) {
...
//            }
    ...
    fun initShown(position : Int){
        ...
        if (mark[position].tOTALMARKCE2 != "N") {
            binding.editTextPF.setText(mark[position].tOTALMARKCE2)
        }else{
            binding.editTextPF.setText("")
        }
        if (mark[position].tOTALMARKCE3 != "N") {
            binding.editTextSEA.setText(mark[position].tOTALMARKCE3)
        }else{
            binding.editTextSEA.setText("")
        }
    }
