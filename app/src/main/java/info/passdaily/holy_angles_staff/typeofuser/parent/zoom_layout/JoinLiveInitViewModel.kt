...
//    }
    ...
    fun getLiveClassList(academicId: Int,classId : Int,subjectId: Int,studentId : Int,schoolId :Int) = liveData(
        Dispatchers.IO) {
        emit(Resource.loading(data = null))
        try {
            emit(Resource.success(data = mainRepository.getJoinLiveNew(academicId,classId,subjectId,studentId,schoolId)))
