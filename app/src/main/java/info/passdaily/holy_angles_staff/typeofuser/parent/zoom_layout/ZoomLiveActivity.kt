package info.passdaily.holy_angles_staff.typeofuser.parent.zoom_layout
...
import info.passdaily.holy_angles_staff.databinding.ActivityZoomLiveBinding
import info.passdaily.holy_angles_staff.services.Global
import info.passdaily.holy_angles_staff.services.Utils
import info.passdaily.holy_angles_staff.services.initsdk.AuthConstants
import info.passdaily.holy_angles_staff.services.initsdk.InitAuthSDKCallback
import info.passdaily.holy_angles_staff.services.initsdk.InitAuthSDKHelper
...
class ZoomLiveActivity : AppCompatActivity(), InitAuthSDKCallback, MeetingServiceListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (extras != null) {
            ...
            aPPSECRETKEY = extras.getString("aPPSECRETKEY")!!
            zOOMMEETINGID = extras.getString("zOOMMEETINGID")!!
            zOOMMEETINGPASSWORD = extras.getString("zOOMMEETINGPASSWORD")!!
        }


        if(studentFcm.STUDENT_NAME.isNotEmpty()){
            STUDENT_NAME = studentFcm.STUDENT_NAME
...
//        setContentView(R.layout.activity_zoom_live)
        ...
        if (savedInstanceState == null) {
            ...
            params.appKey = aPPKEY // TODO: Retrieve your SDK key and enter it here
            params.appSecret = aPPSECRETKEY // TODO: Retrieve your SDK secret and enter it here
        ...
        if (nameEditText?.text.toString().isNotEmpty() && meetingIdEditText?.text.toString().isNotEmpty()
            ...
            try {
                if (!checkPermission()) {
                    ...
                    val meetingID: String = zOOMMEETINGID
                    val name: String = nameEditText?.text.toString()
                    val meetingPassword: String = zOOMMEETINGPASSWORD
