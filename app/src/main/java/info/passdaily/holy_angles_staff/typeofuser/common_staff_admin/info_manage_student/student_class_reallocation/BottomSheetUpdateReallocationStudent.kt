package info.passdaily.holy_angles_staff.typeofuser.common_staff_admin.info_manage_student.student_class_reallocation
...
import info.passdaily.holy_angles_staff.databinding.BottomSheetSendStudentBinding
import info.passdaily.holy_angles_staff.databinding.BottomSheetUpdateReallocationBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.buttonSubmit.setOnClickListener {
            ...
            if(binding.editTextTitle.text.toString().isNotEmpty()) {
                ...
                studentReallocationListener.onErrorMessage("Enter Admission Number")
            }
//            if(binding.editTextTitle.text.toString().isNotEmpty()){
//                if(groupTypeStr != "-1"){
