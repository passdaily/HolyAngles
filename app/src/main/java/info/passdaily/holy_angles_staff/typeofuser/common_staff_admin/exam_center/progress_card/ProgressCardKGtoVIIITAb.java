...
public class ProgressCardKGtoVIIITAb extends Fragment{
    ...
    public ProgressCardKGtoVIIITAb(){}


    public ProgressCardKGtoVIIITAb(int aCCADEMICID, int cLASSID, int eXAMID, int adminId, String cLASSNAME){
