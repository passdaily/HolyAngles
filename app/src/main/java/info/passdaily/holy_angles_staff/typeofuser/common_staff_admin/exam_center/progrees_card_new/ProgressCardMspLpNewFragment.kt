...
class ProgressCardMspLpNewFragment(var title : String) : Fragment() {
...
//        constraintLayout  = binding.constraintLayout
    ...
    private fun progressFun() {
        ...
        progressCardViewModel.getProgressReportMsp("MarkMspLpUp/ProgressReportMsp",aCCADEMICID, cLASSID, eXAMID, adminId)
            .observe(requireActivity(), Observer {
                it?.let { resource ->
...
//                                            }
                                            ...
                                            var totalMark = markList[mark].tOTALMARKCE1  + markList[mark].tOTALMARKCE2+
                                                    markList[mark].tOTALMARKCE3  + markList[mark].tOTALMARK
...
//                    (screenWidth - context.resources.getDimension(R.dimen.screen_width_msp_lp).toInt()) / 1
            ...
            override fun onBindViewHolder(holder: ViewHolder, position: Int) {
                ...
                holder.textViewMark.text = "PT : ${subjectsList[position].tOTALMARKCE1}  |  PF : ${subjectsList[position].tOTALMARKCE2} "+
                        "|  SEA : ${subjectsList[position].tOTALMARKCE3} | MRK : ${subjectsList[position].tOTALMARK}"
