...
import info.passdaily.holy_angles_staff.databinding.ActivityPrivateMeetingBinding
import info.passdaily.holy_angles_staff.model.ZakAccessTokenModel
import info.passdaily.holy_angles_staff.model.ZoomGoLiveDetailsModel
import info.passdaily.holy_angles_staff.model.ZoomSdkUserModel
...
import info.passdaily.holy_angles_staff.services.initsdk.ZoomMeetingUISettingHelper
...
//        ZoomSDK.getInstance().addAuthenticationListener(this)
    ...
    override fun onZoomAuthIdentityExpired() {}
    override fun onNotificationServiceStatus(p0: ZoomSDKAuthenticationListener.SDKNotificationServiceStatus?) {
        Log.i(TAG, "onNotificationServiceStatus!")
    }
