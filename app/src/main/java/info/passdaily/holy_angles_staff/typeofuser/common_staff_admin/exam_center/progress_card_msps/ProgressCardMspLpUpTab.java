...
public  class ProgressCardMspLpUpTab extends Fragment{

    String year,exam,sclass,s_cname,s_ename;

    int aCCADEMICID,cLASSID,eXAMID,adminId;
    String cLASSNAME ;
    public ProgressCardMspLpUpTab(){}

    public ProgressCardMspLpUpTab(int aCCADEMICID, int cLASSID, int eXAMID, int adminId,String cLASSNAME){
...
// "TOTAL_MARK_CE_4":null,"MARK_GRADE":"AB","MARK_DATE":"2019-10-24T16:01:02.02","MARKED_BY":1}
                        ...
                        String totalmark="0.0",totalmarkce_1="0.0",totalmarkce_2="0.0",totalmarkce_3="0.0";
                      //  a1=markList.get(z).get("MARK_GRADE");
                            ...
                            if (subjectlist.get(y).get("SUBJECT_ID").equals(markList.get(z).get("SUBJECT_ID"))){
                                ...
                                for(int c=0;c<subjt.length;c++) {
                                    if (subjt[c].equals(n)){
                                        ...
                                        if (markList.get(z).get("TOTAL_MARK").equals("-1.0")){ markList.get(z).put("TOTAL_MARK","AB");}
                                            ...
                                            if(markList.get(z).get("TOTAL_MARK").contains("AB")&&markList.get(z).get("TOTAL_MARK_CE_1").contains("AB")
                                              ...
                                              //  G="AB";
                                                temp1= markList.get(z).get("TOTAL_MARK_CE_1")+" | "+markList.get(z).get("TOTAL_MARK_CE_2")+" | "
                                                        +markList.get(z).get("TOTAL_MARK_CE_3")+" | "+markList.get(z).get("TOTAL_MARK")
                                                        +" | "+String.valueOf(sumMark)+" | "+markList.get(z).get("MARK_GRADE")+"~";


                                                temp= markList.get(z).get("TOTAL_MARK_CE_1")+"p"+markList.get(z).get("TOTAL_MARK_CE_2")+"p"
                                                        +markList.get(z).get("TOTAL_MARK_CE_3")+"p"+markList.get(z).get("TOTAL_MARK")
                                                        +"p"+" -- "+"p"+markList.get(z).get("MARK_GRADE")+"~";
                                            }else{
                                                temp1= markList.get(z).get("TOTAL_MARK_CE_1")+" | "+markList.get(z).get("TOTAL_MARK_CE_2")+" | "
                                                        +markList.get(z).get("TOTAL_MARK_CE_3")+" | "+markList.get(z).get("TOTAL_MARK")+" | "+String.valueOf(sumMark)
                                                        +" | "+markList.get(z).get("MARK_GRADE")+"~";


                                                temp= markList.get(z).get("TOTAL_MARK_CE_1")+"p"+markList.get(z).get("TOTAL_MARK_CE_2")+"p"
                                                        +markList.get(z).get("TOTAL_MARK_CE_3")+"p"+markList.get(z).get("TOTAL_MARK")
                                                        +"p"+String.valueOf(sumMark)+"p"+markList.get(z).get("MARK_GRADE")+"~";
                                            }
...
//                String[] addExtraString1={String.valueOf(flcnt)};
//                String[] addExtraString2={String.valueOf(passcnt)};
//                String[] addExtraString3={String.valueOf(passcnt)};
//                String[] addExtraString4={ status};
//                String[] addExtraString5={String.valueOf(tot)};
//                String[] addExtraString6={s+"%"};
                ...
                String[] pstring = new String[0];
                List <String> array3 = new ArrayList <>();

                Log.i(TAG,"count -"+info.length);
                Log.i(TAG,"Header -"+header.length);

//                for(int ii=0;ii<header.length-1;ii++){
//                    Log.i(TAG,"Header1 -"+ii);
                    for(int a=0;a<info.length;a++){
                        Log.i(TAG,"info.length -"+a);
                        pstring=info[a].split("p");
               ...
               // }
                ...
                for(int J=0;J<(addExtraString.length);J++){
                    ...
                    TextView textViewB = this.headerTextView(addExtraString[J]);
//                    textViewB.setBackgroundResource(R.drawable.cellshapes_two);
//                    textViewB.setTextSize(12f);
...
//                        Collections.addAll(array4, info);
                        ...
                        BottomSheetProgressCard bottomSheet =
                                new BottomSheetProgressCard(addExtra_String,sampleObject,
                                        cLASSNAME,
                                        stafflist.get(0).get("STAFF_FNAME"), info,subjectlist,"MspsLp");
        ...
        public ProgressCardTableRow_CE(Context context,String year,String exam,String sclass){
           ...
           // http://demostaff.passdaily.in/ElixirApi/MarkMspLpUp/ProgressReportMsp?AccademicId=6&ClassId=5&ExamId=3&AdminId=1&Dummy=0

            //MarkDon/ProgressReportDon?AccademicId=6&ClassId=5&ExamId=1&AdminId=1&Dummy=0
            GET_MarkList= FileUtils.url+"MarkMspLpUp/ProgressReportMsp?AccademicId=" +aCCADEMICID+
...
//                                "TOTAL_MARK_CE_3":-1.0,"TOTAL_MARK_CE_4":null,"MARK_GRADE":"AB","MARK_DATE":"2019-10-24T16:01:02.02","MARKED_BY":1}
        ...
        TableRow componentATableRow(){
            ...
            componentATabele.addView(textView,params);
        ...
        TableRow componentBTableRow(){
            ...
            String[] addExtraString={" "," "," "," "," "," "};
            TableRow.LayoutParams params = new TableRow.LayoutParams(770,LayoutParams.MATCH_PARENT);
            params.setMargins(2,2,2,0);
...
//            for(int j=0 ;j<(addExtraString.length);j++){
//                TableRow.LayoutParams params = new TableRow.LayoutParams(150,LayoutParams.MATCH_PARENT);
//                params.setMargins(2,0,2,0);
//                TextView textView1 =this.bodyTextView(addExtraString[j]);
//                textView1.setLayoutParams(params);
//                textView1.setBackgroundResource(R.drawable.cellshapes);
//                componentBTableRow.addView(textView1);
//            }
            componentBTableRow.setBackgroundColor(getResources().getColor(R.color.green_100));
            return  componentBTableRow;
        }
...
//                TableRow.LayoutParams params = new TableRow.LayoutParams(150,LayoutParams.MATCH_PARENT);
//                params.setMargins(2,0,2,0);
//                TextView textView1 =this.headerTextView(addExtraString[j]);
//                textView1.setLayoutParams(params);
//                textView1.setBackgroundResource(R.drawable.cellshapes);
//                componentBTableRow.addView(textView1);
//            }
...
//////new Original code
            ...
            mTableLayout.setLayoutParams(new TableLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));


            String[] add={"PT","PF","SEA","MRK","TOT","GRD"};
...
//
//                   TextView textView1 =this.bodyTextView("text : "+count);
//
//                    textView1.setBackgroundResource(R.drawable.cellshapes);
...
//
//
////                TextView valueTV = new TextView(this.context);
...
//            TableRow mTableLayout= new TableRow(this.context);
////            int headerFieldCount =this.header.length;
////
//            TableRow.LayoutParams params = new TableRow.LayoutParams(150,LayoutParams.MATCH_PARENT);
//            params.setMargins(2,0,2,0);
...
//              //  Collections.addAll(array3,"PT  |  PF  |  SEA  |  MRK  |  TOT  |  GRD");
//                for(int j=0 ;j<(add.length);j++){
//                    TextView textView1 =this.bodyTextView(add[j]);
//                    textView1.setLayoutParams(params);
//                    textView1.setBackgroundResource(R.drawable.cellshapes);
//                    mTableLayout.addView(textView1);
//                }
//            }
////            Collections.addAll(array3,addExtraString);
////            //may be want to changes here
////            // for(int i=0 ;i<(headerFieldCount-1);i++){
////            for(int i=0 ;i<(array3.size()-1);i++){
////                TableRow.LayoutParams params = new TableRow.LayoutParams(670,LayoutParams.MATCH_PARENT);
////                params.setMargins(2,0,2,0);
