...
class ExamGradeCeFragment(var url : String,var title : String) : Fragment() {


    var TAG = "ExamGradeCeFragment"
    ...
    private fun getExamGrade(aCCADEMICID: Int, cLASSID: Int, eXAMID: Int) {
        examGradeViewModel.getExamGradeCeResponse(
                ...
                it?.let { resource ->
                    when (resource.status) {
                        Status.SUCCESS -> {
                            ...
                            var getExamGradeCbse = response.examGrade as ArrayList<ExamGradeCeModel.ExamGrade>
...
//                                    getGradeCommonModel.add(GradeCommonModel(0,0,
//                                        0,0,
...
//            var textViewE : TextView = view.findViewById(R.id.textViewE)
        ...
        override fun onCreateViewHolder(
            ...
            val itemView = LayoutInflater.from(parent.context)
                .inflate(R.layout.exam_grade_ce_adapter, parent, false)
...
//            }
          ...
          //  holder.textPassMark.text = "Passmark : "
