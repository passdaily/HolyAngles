...
//import info.passdaily.holy_angles_staff.databinding.ActivityZoomGoLiveBinding
...
//import info.passdaily.holy_angles_staff.services.retrofit.RetrofitClientZoom
//import info.passdaily.holy_angles_staff.typeofuser.common_staff_admin.home.StudentActivity
//import info.passdaily.holy_angles_staff.typeofuser.parent.zoom_layout.Credentials
...
//
//                                Credentials.JWT_TOKEN = zoomLoginDetails[i].zZOOMACCESSTOKEN
//                               // Credentials.JWT_TOKEN = "eyJzdiI6IjAwMDAwMSIsImFsZyI6IkhTNTEyIiwidiI6IjIuMCIsImtpZCI6ImRhM2NhOTBkLTI3ZTAtNDZhNy05MjA2LTY2MGE5NWFhNDJhNiJ9..xzIPgar-lzJFrnOeSxk44Xpe4qtI3Zj8c5AhrcbjDVWAZ-F6lDpHaYiSuhbkAldHI7uszEjq4GdO6mdb23BSPA"
//
//                                email = Credentials.SDK_EMAIL
//                                password = Credentials.SDK_PASSWORD
//                            }
...
//        zoomGoLiveViewModel.getClassDetails(adminId,aCCADEMICID,schoolId)
//            .observe(this, Observer {
//                it?.let { resource ->
//                    Log.i(TAG,"resource $resource")
//                    when (resource.status) {
