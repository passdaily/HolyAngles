...
import info.passdaily.holy_angles_staff.databinding.ActivitySelfieBinding
import info.passdaily.holy_angles_staff.databinding.FragmentAdminSelfieBinding
...
import info.passdaily.holy_angles_staff.services.Utils.Companion.compressImage
import info.passdaily.holy_angles_staff.services.localDB.LocalDBHelper
import info.passdaily.holy_angles_staff.typeofuser.testing_area.staff_attendance_test.Overlay
import java.io.File
import java.util.*
import java.util.concurrent.ExecutorService
import java.util.concurrent.Executors

class AdminSelfieFragment() : Fragment() {



    private lateinit var cameraExecutor: ExecutorService
   // private lateinit var binding: ActivitySelfieBinding
    private var _binding: FragmentAdminSelfieBinding? = null
    ...
    var imageViewFlip : ImageView? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAdminSelfieBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        imageViewFlip  = binding.imageViewFlip
...
//            }
        ...
        imageViewFlip?.setOnClickListener {
...
//               requireActivity().supportFragmentManager.beginTransaction().remove(fragment).commit();
                ...
                fragmentTransaction.replace(R.id.nav_staff_host_fragment, AdminStaffAttendanceFragment(1,commentUplodedFile)).commit()
            }
