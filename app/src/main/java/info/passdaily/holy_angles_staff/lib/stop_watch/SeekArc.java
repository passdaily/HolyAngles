package info.passdaily.holy_angles_staff.lib.stop_watch;
...
//         */
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        int arcColor = res.getColor(R.color.blue_100);
        int progressColor = res.getColor(R.color.green_400);
        ...
        if (attrs != null) {
            ...
            mArcWidth = (int) a.getDimension(R.styleable.SeekArc_arcWidth,
                    mArcWidth);
            mStartAngle = a.getInt(R.styleable.SeekArc_start_Angle, mStartAngle);
            ...
            progressColor = a.getColor(R.styleable.SeekArc_progress_Color,
                    progressColor);
