...
import info.passdaily.holy_angles_staff.services.downloader.Constants;
import info.passdaily.holy_angles_staff.services.downloader.Error;
import info.passdaily.holy_angles_staff.services.downloader.Progress;
...
import info.passdaily.holy_angles_staff.services.downloader.database.DownloadModel;
import info.passdaily.holy_angles_staff.services.downloader.handler.ProgressHandler;
import info.passdaily.holy_angles_staff.services.downloader.httpclient.HttpClient;
import info.passdaily.holy_angles_staff.services.downloader.internal.stream.FileDownloadOutputStream;
import info.passdaily.holy_angles_staff.services.downloader.internal.stream.FileDownloadRandomAccessFile;
...
public class DownloadTask {
    ...
    Response run() {
        ...
        if (request.getStatus() == StatusD.CANCELLED) {
            response.setCancelled(true);
            return response;
        } else if (request.getStatus() == StatusD.PAUSED) {
