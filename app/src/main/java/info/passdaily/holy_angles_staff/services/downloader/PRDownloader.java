...
package info.passdaily.holy_angles_staff.services.downloader;
...
import info.passdaily.holy_angles_staff.services.downloader.request.DownloadRequestBuilder;
...
public class PRDownloader {
     ...
     */
    public static StatusD getStatus(int downloadId) {
