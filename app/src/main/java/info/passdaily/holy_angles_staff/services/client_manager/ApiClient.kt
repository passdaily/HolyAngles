package info.passdaily.holy_angles_staff.services.client_manager


import info.passdaily.holy_angles_staff.services.retrofit.ApiInterface
...
class ApiClient( private val apiServices  : ApiInterface) {
    ...
    suspend fun getJoinLiveNew(academicId: Int,classId : Int,subjectId: Int,studentId : Int,schoolId :Int)
            = apiServices.joinLiveNew(academicId,classId,subjectId,studentId,schoolId)
...
//            = apiServices.onlineExamStatus(academicId,classId,studentId,oExamId)
    ...
    suspend fun getClassDetails(adminId: Int,accademicId :Int,schoolId:Int) = apiServices.classDetails(adminId,accademicId,schoolId)

    //getMeetingListByAdmin(accademicId,adminId))
    suspend fun getMeetingListByAdmin(accademicId: Int,adminId :Int,schoolId :Int) = apiServices.meetingListByAdmin(accademicId,adminId,schoolId)
