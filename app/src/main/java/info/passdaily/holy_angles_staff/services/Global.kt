...
class Global {
    companion object {
        //http://holy.passdaily.in
        var student_image_url = "http://holy.passdaily.in/StudentImages/"
        var staff_image_url = "http://holy.passdaily.in/Photos/StaffImage/"

        var event_url = "http://holy.passdaily.in"
        //http://teachdaily.in/ba9b8405-5468-415f-8f64-e14786b1ed95IMG_1652361489497.jpg
        var image_url = "http://holy.passdaily.in/Album_File"
        var screenState = "landingpage"
        var study_url = "http://holy.passdaily.in/StudyMeterials/"

        var voice_url = "http://holy.passdaily.in/voice%20mail/"
