...
package info.passdaily.holy_angles_staff.services.downloader.request;

import info.passdaily.holy_angles_staff.services.downloader.Error;
import info.passdaily.holy_angles_staff.services.downloader.OnCancelListener;
import info.passdaily.holy_angles_staff.services.downloader.OnDownloadListener;
import info.passdaily.holy_angles_staff.services.downloader.OnPauseListener;
import info.passdaily.holy_angles_staff.services.downloader.OnProgressListener;
import info.passdaily.holy_angles_staff.services.downloader.OnStartOrResumeListener;
import info.passdaily.holy_angles_staff.services.downloader.Priority;
...
import info.passdaily.holy_angles_staff.services.downloader.core.Core;
import info.passdaily.holy_angles_staff.services.downloader.internal.ComponentHolder;
import info.passdaily.holy_angles_staff.services.downloader.internal.DownloadRequestQueue;
import info.passdaily.holy_angles_staff.services.downloader.internal.SynchronousCall;
import info.passdaily.holy_angles_staff.services.downloader.utils.Utils;
...
public class DownloadRequest {
    ...
    public StatusD getStatus() {
        return status;
    }

    public void setStatus(StatusD status) {
        this.status = status;
    }
    ...
    public void deliverError(final Error error) {
        if (status != StatusD.CANCELLED) {
            setStatus(StatusD.FAILED);
